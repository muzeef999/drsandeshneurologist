  ...
  return (
    <div className="container">
      <section>
        ...
        <div style={{ overflowX: 'auto', overflowY: 'hidden', overflow:'hidden', width: '100%', maxWidth: '100vw' }}>
              <svg width="100%" height="auto"    id="yourSvgElement" 
              ...
              >
                <g id="Group91">
                  <g id="Group">
                    <g id="Group 89">
                      <g id="eo6">
                        <g id="Rectangle 87" filter="url(#filter0_d_263_137)">
                          <rect
                            x="1975"
                            y="348"
                            width="626"
                      ...
                      <g id="eo5">
                        <g id="Rectangle 87_2" filter="url(#filter1_d_263_137)">
                          <rect
                            x="1635"
                            y="19"
                            width="626"
                      ...
                      <g id="eo4">
                        <g id="Rectangle 87_3" filter="url(#filter2_d_263_137)">
                          <rect
                            x="1189"
                            y="348"
                            width="626"
                      ...
                      <g id="eo3">
                        <g id="Rectangle 87_4" filter="url(#filter3_d_263_137)">
                          <rect
                            x="849"
                            y="19"
                            width="626"
                      ...
                      <g id="eo2">
                        <g id="Rectangle 87_5" filter="url(#filter4_d_263_137)">
                          <rect
                            x="339"
                            y="348"
                            width="626"
                      ...
                      <g id="eo1">
                        <g id="Rectangle 87_6" filter="url(#filter5_d_263_137)">
                          <rect
                            x="27"
                            y="19"
                            width="626"
